...
abstract public class ActivityBase extends Activity {
    ...
    public void onBackPressed(){
        if (mOrientationCompensation == 270 || mOrientationCompensation == 90){
            Log.v(TAG,"freeze rotation temporarily");
            try {
                int setting_rotation = Settings.System.getInt(getContentResolver(),Settings.System.ACCELEROMETER_ROTATION);
                ...
                Log.w(TAG,"Rotation Setting not found");
            } catch (RemoteException exc) {
                Log.w(TAG, "Unable to disable auto rotation");
            }
        }
        finish();
    }
